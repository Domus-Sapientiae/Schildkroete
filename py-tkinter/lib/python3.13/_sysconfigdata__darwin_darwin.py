...
build_time_vars = {
    ...
    'BASECPPFLAGS': '',
    'BASEMODLIBS': '',
    'BINDIR': '/Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter/bin',
    'BINLIBDEST': '/Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter/lib/python3.13',
    'BLDLIBRARY': 'libpython3.13.a',
    'BLDSHARED': 'gcc -bundle -undefined dynamic_lookup -L/opt/homebrew/opt/tcl-tk/lib -L/opt/homebrew/opt/tcl-tk/lib',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '.exe',
    ...
    'CONFIGURE_CPPFLAGS': '-I/opt/homebrew/opt/tcl-tk/include',
    'CONFIGURE_LDFLAGS': '-L/opt/homebrew/opt/tcl-tk/lib',
    'CONFIGURE_LDFLAGS_NODIST': '',
    'CONFIGURE_LDFLAGS_NOLTO': '',
    'CONFIG_ARGS': "'--prefix=/Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter' '--with-tcltk-includes=-I/opt/homebrew/opt/tcl-tk/include' '--with-tcltk-libs=-L/opt/homebrew/opt/tcl-tk/lib -ltcl9.0 -ltk9.0' 'PKG_CONFIG_PATH=/opt/homebrew/opt/tcl-tk/lib/pkgconfig' 'LDFLAGS=-L/opt/homebrew/opt/tcl-tk/lib' 'CPPFLAGS=-I/opt/homebrew/opt/tcl-tk/include'",
    'CONFINCLUDEDIR': '/Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter/include',
    'CONFINCLUDEPY': '/Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter/include/python3.13',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/Users/katharine_h/Schildkroete/Python-3.13.0/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/Users/katharine_h/Schildkroete/Python-3.13.0/lcov-report',
    'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage --title "CPython 3.13 LCOV report [commit $(shell )]"',
    'CPPFLAGS': '-I. -I./Include -I/opt/homebrew/opt/tcl-tk/include -I/opt/homebrew/opt/tcl-tk/include',
    'CXX': 'g++',
    'DESTDIRS': '/Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter /Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter/lib /Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter/lib/python3.13 /Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter/lib/python3.13/lib-dynload',
    'DESTLIB': '/Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter/lib/python3.13',
    'DESTPATH': '',
    'DESTSHARED': '/Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter/lib/python3.13/lib-dynload',
    'DFLAGS': '',
    'DIRMODE': 755,
    ...
    'EXE': '',
    'EXEMODE': 755,
    'EXENAME': '/Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter/bin/python3.13',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    ...
    'INCLDIRSTOMAKE': '/Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter/include /Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter/include /Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter/include/python3.13 /Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter/include/python3.13',
    'INCLUDEDIR': '/Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter/include',
    'INCLUDEPY': '/Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter/include/python3.13',
    ...
    'JIT_DEPS': '\\',
    'LDCXXSHARED': 'g++ -bundle -undefined dynamic_lookup -L/opt/homebrew/opt/tcl-tk/lib -L/opt/homebrew/opt/tcl-tk/lib',
    'LDFLAGS': '-L/opt/homebrew/opt/tcl-tk/lib -L/opt/homebrew/opt/tcl-tk/lib',
    'LDFLAGS_NODIST': '',
    'LDLIBRARY': 'libpython3.13.a',
    'LDLIBRARYDIR': '',
    'LDSHARED': 'gcc -bundle -undefined dynamic_lookup -L/opt/homebrew/opt/tcl-tk/lib -L/opt/homebrew/opt/tcl-tk/lib',
    'LDVERSION': '3.13',
    'LIBC': '',
    'LIBDEST': '/Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter/lib/python3.13',
    'LIBDIR': '/Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter/lib',
    'LIBEXPAT_A': 'Modules/expat/libexpat.a',
    'LIBEXPAT_CFLAGS': '-I./Modules/expat -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/opt/homebrew/opt/tcl-tk/include -I/opt/homebrew/opt/tcl-tk/include',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    ...
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': '/Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter/lib/pkgconfig',
    'LIBPL': '/Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter/lib/python3.13/config-3.13-darwin',
    'LIBPYTHON': '',
    ...
    'MACHDEP': 'darwin',
    'MACHDEP_OBJS': '',
    'MACHDESTLIB': '/Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter/lib/python3.13',
    'MACOSX_DEPLOYMENT_TARGET': '14.6',
    'MAJOR_IN_MKDEV': 0,
    'MAJOR_IN_SYSMACROS': 0,
    'MAKESETUP': './Modules/makesetup',
    'MANDIR': '/Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter/share/man',
    'MIMALLOC_HEADERS': '\\',
    ...
    'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/opt/homebrew/opt/tcl-tk/include -I/opt/homebrew/opt/tcl-tk/include -DPy_BUILD_CORE_BUILTIN',
    ...
    'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/opt/homebrew/opt/tcl-tk/include -I/opt/homebrew/opt/tcl-tk/include -DPy_BUILD_CORE',
    'PY_CORE_LDFLAGS': '-L/opt/homebrew/opt/tcl-tk/lib -L/opt/homebrew/opt/tcl-tk/lib',
    'PY_CPPFLAGS': '-I. -I./Include -I/opt/homebrew/opt/tcl-tk/include -I/opt/homebrew/opt/tcl-tk/include',
    'PY_ENABLE_SHARED': 0,
    'PY_HAVE_PERF_TRAMPOLINE': 0,
    'PY_LDFLAGS': '-L/opt/homebrew/opt/tcl-tk/lib -L/opt/homebrew/opt/tcl-tk/lib',
    'PY_LDFLAGS_NODIST': '',
    'PY_LDFLAGS_NOLTO': '-L/opt/homebrew/opt/tcl-tk/lib -L/opt/homebrew/opt/tcl-tk/lib',
    ...
    'RETSIGTYPE': 'void',
    'RUNSHARED': '',
    'SCRIPTDIR': '/Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter/lib',
    ...
    'VERSION': '3.13',
    'WASM_ASSETS_DIR': './Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter',
    'WASM_STDLIB': './Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter/lib/python3.13/os.py',
    'WHEEL_PKG_DIR': '',
    'WINDOW_HAS_FLAGS': 1,
    ...
    'abs_builddir': '/Users/katharine_h/Schildkroete/Python-3.13.0',
    'abs_srcdir': '/Users/katharine_h/Schildkroete/Python-3.13.0',
    'datarootdir': '/Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter/share',
    'exec_prefix': '/Users/katharine_h/Schildkroete/Python-3.13.0/../py-tkinter',
